...
<table width="920" border="0" align="center" cellpadding="5" cellspacing="0">
  <tbody>
      ...
      <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
        <tbody>
          <tr>
            ...
            <td><input name="faculty_name" type="text" id="faculty_name" size="30" value="{{old('faculty_name')}}">
          ...
          <tr>
            ...
            <td><input type="checkbox" name="faculty_dspl_flag" id="faculty_dspl_flag" value="1" @if(old('faculty_dspl_flag') == 1) checked @endif >一時的に一般画面に表示しない</td>
          </tr>
        </tbody>
      </table></td>
    </tr>
    <tr>
      ...
      　　　　　
        <input type="reset" id="btn-reset" value="クリア"></td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
    </tr>
